      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-ink px-2.5 py-0.5 text-xs font-black text-white shadow-md z-50 pointer-events-none"
          >
            {muted ? '已静音 🔇' : '声音已开启 🔊'}
          </motion.div>
        )}

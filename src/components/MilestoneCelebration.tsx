    ...
    <>
      ...
      <div className="card-candy p-4">
        <div className="mb-2 flex items-center justify-between">
          <span className="text-sm font-extrabold text-ink-soft">{t('milestoneCelebration.progressLabel')}</span>
        ...
        <p className="mt-1.5 text-xs font-semibold text-ink-soft">
          {achieved === 0
            ? t('milestoneCelebration.emptyMsg')
            : t('milestoneCelebration.inProgressMsg', { pct })}
        </p>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="mt-3 inline-block rounded-full bg-amber-400 px-4 py-1 text-xs font-black text-amber-950 shadow-sm">
                {t('milestoneCelebration.modalLabel')}
              </div>
              ...
              <div className="mt-6">
                <CandyButton tone="green" size="lg" fullWidth onClick={handleClose}>
                  {t('milestoneCelebration.continueBtn')}
                </CandyButton>
              </div>
            </motion.div>
          </Modal>

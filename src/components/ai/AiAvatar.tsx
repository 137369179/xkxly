  ...
  return (
    ...
    >
      <svg viewBox="0 0 48 48" width={size} height={size}>
        ...
        {mood === 'sleep' ? (
          <>
            <path d="M15 25 q3.5 3 7 0" stroke="#6631c7" strokeWidth="2.2" fill="none" strokeLinecap="round" />
            <path d="M26 25 q3.5 3 7 0" stroke="#6631c7" strokeWidth="2.2" fill="none" strokeLinecap="round" />
          </>
        ) : (
          <>
            <circle cx="18.5" cy="24" r="2.9" fill="#6631c7" />
            <circle cx="29.5" cy="24" r="2.9" fill="#6631c7" />
        ...
        {/* 嘴 */}
        {mood === 'talking' ? (
          <ellipse cx="24" cy="30.5" rx="3.4" ry="2.2" fill="#ff8db0" />
        ) : mood === 'celebrating' ? (
          <path d="M19 29 q5 5 10 0 q-5 3 -10 0z" fill="#ff8db0" stroke="none" />
        ) : (

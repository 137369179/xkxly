...
export const MEDAL_GLYPHS: Record<string, React.ReactNode> = {
  ...
  scholar: (
    <>
      <path d="M34 10 L26 44 L40 44 Z" fill="#ff5c8a" />
      <path d="M62 10 L70 44 L56 44 Z" fill="#ff5c8a" />
      <path d="M40 10 H56 L48 40 Z" fill="#FF9CC4" />
      <circle cx="48" cy="56" r="32" fill="#FFC53D" />
      <circle cx="48" cy="56" r="26" fill="#FFF3D2" stroke="#FFE0A3" strokeWidth={2} />
      <path d="M36 50 L40 40 L44 48 H52 L56 40 L60 50 C62 54 62 64 48 66 C34 64 34 54 36 50 Z" fill="#ff5c8a" />
  ...
  pinyin: (
    <>
      <path d="M34 10 L26 44 L40 44 Z" fill="#62CC8A" />
      <path d="M62 10 L70 44 L56 44 Z" fill="#62CC8A" />
      <circle cx="48" cy="56" r="32" fill="#62CC8A" />
      <circle cx="48" cy="56" r="26" fill="#DDF7E7" stroke="#BBEFCF" strokeWidth={2} />
      <path d="M32 60 L38 44 L44 52 H52 L58 44 L64 60 C66 66 30 66 32 60 Z" fill="#62CC8A" />
  ...
  math: (
    <>
      <path d="M34 10 L26 44 L40 44 Z" fill="#FF9F2E" />
      <path d="M62 10 L70 44 L56 44 Z" fill="#FF9F2E" />
      <circle cx="48" cy="56" r="32" fill="#FFC53D" />
      <circle cx="48" cy="56" r="26" fill="#FFF3D2" stroke="#FFE0A3" strokeWidth={2} />
      <path d="M32 62 L40 42 L48 52 H48 L56 42 L64 62 Z" fill="#8f5bff" strokeLinejoin="round" />
      <rect x="30" y="60" width="36" height="6" rx="3" fill="#8f5bff" />
  ...
  nurture: (
    <>
      <path d="M34 10 L26 44 L40 44 Z" fill="#ff5c8a" />
      <path d="M62 10 L70 44 L56 44 Z" fill="#ff5c8a" />
      <circle cx="48" cy="56" r="32" fill="#ff5c8a" />
      ...
      <path d="M48 70 C48 70 34 58 34 50 C34 44 40 40 44 43 C48 46 48 46 48 46 C48 46 48 46 52 43 C56 40 62 44 62 50 C62 58 48 70 48 70 Z" fill="#ff5c8a" />

...
export const PET_GLYPHS: Record<string, React.ReactNode> = {
  ...
  cat_fish: (
    <>
      <path d="M48 32 L60 22 C61 27 61 37 60 42 Z" fill="#FF9F2E" />
      <path d="M8 32 C8 19 36 15 50 32 C36 49 8 45 8 32 Z" fill="#FFC53D" />
  ...
  cat_heart: (
    <>
      ...
      <path d="M32 56 C32 56 11 41 11 27 C11 19 18 14 25 17 C30 19 32 23 32 23 C32 23 34 19 39 17 C46 14 53 19 53 27 C53 41 32 56 32 56 Z" fill="#ff5c8a" />
  ...
  cat_bath: (
    <>
      <ellipse cx="32" cy="48" rx="26" ry="8" fill="#dcebff" />
      <path d="M18 24 L24 12 L30 22 H34 L40 12 L46 24 C50 28 50 42 32 44 C14 42 14 28 18 24 Z" fill="#3d9bff" />
  ...
  cat_comb: (
    <>
      ...
      <path d="M20 20 C20 12 44 12 44 20 C48 26 48 36 32 38 C16 36 16 26 20 20 Z" fill="#ff5c8a" />
  ...
  cat_pawpet: (
    <>
      ...
      <ellipse cx="32" cy="44" rx="8" ry="6" fill="#ff5c8a" />
      <circle cx="22" cy="34" r="3.5" fill="#ff5c8a" />
      <circle cx="28" cy="30" r="3.5" fill="#ff5c8a" />
      <circle cx="36" cy="30" r="3.5" fill="#ff5c8a" />
      <circle cx="42" cy="34" r="3.5" fill="#ff5c8a" />
      <path d="M22 16 L24 20 L28 22 L24 24 L22 28 L20 24 L16 22 L20 20 Z" fill="#FFC53D" />
      <path d="M42 12 L43.5 15 L46.5 16.5 L43.5 18 L42 21 L40.5 18 L37.5 16.5 L40.5 15 Z" fill="#FFC53D" />
    </>
  ),
  // 6. 猫耳礼盒 / 每日领小鱼干
  cat_gift: (
    <>
      ...
      <rect x="12" y="20" width="40" height="10" rx="3" fill="#8f5bff" />
      <rect x="16" y="30" width="32" height="26" rx="6" fill="#8f5bff" />
      <rect x="29" y="20" width="6" height="36" fill="#FF9CC4" />
      <circle cx="32" cy="25" r="4" fill="#FFC53D" />
  ...
  cat_crown: (
    <>
      <path d="M12 48 L10 22 L22 34 L32 14 L42 34 L54 22 L52 48 Z" fill="#FFC53D" strokeLinejoin="round" />
      <rect x="10" y="44" width="44" height="8" rx="4" fill="#FFE0A3" />
      <path d="M32 26 L36 32 L32 38 L28 32 Z" fill="#ff5c8a" />
  ...
  cat_glasses: (
    <>
      <path d="M10 24 L16 16 L22 24 H30 C30 36 10 36 10 24 Z" fill="#FFE0EF" stroke="#ff5c8a" strokeWidth={3} strokeLinejoin="round" />
      <path d="M34 24 H42 L48 16 L54 24 C54 36 34 36 34 24 Z" fill="#FFE0EF" stroke="#ff5c8a" strokeWidth={3} strokeLinejoin="round" />
      <path d="M30 26 H34" stroke="#ff5c8a" strokeWidth={3} strokeLinecap="round" />
  ...
  cat_bow: (
    <>
      <path d="M32 32 L12 18 C8 26 8 38 12 46 Z" fill="#ff5c8a" strokeLinejoin="round" />
      <path d="M32 32 L52 18 C56 26 56 38 52 46 Z" fill="#ff5c8a" strokeLinejoin="round" />
      <circle cx="32" cy="32" r="7" fill="#FFC53D" />
  ...
  cat_tie: (
    <>
      <polygon points="26,14 38,14 36,22 28,22" fill="#3d9bff" />
      <polygon points="28,22 36,22 40,48 32,56 24,48" fill="#3d9bff" />
  ...
  cat_bed: (
    <>
      ...
      <ellipse cx="32" cy="44" rx="24" ry="12" fill="#FF9F2E" />
  ...
  cat_wand: (
    <>
      <path d="M12 52 L36 28" stroke="#3d9bff" strokeWidth={4} strokeLinecap="round" />
      <circle cx="38" cy="26" r="5" fill="#FFC53D" />
      <Face cx={38} cy={26} gap={3} dot={1.7} cheek={false} />
      <path d="M42 22 C52 14 56 8 58 10 C56 18 46 24 42 22 Z" fill="#ff5c8a" />
      <path d="M40 28 C52 28 58 24 60 27 C56 32 44 32 40 28 Z" fill="#8f5bff" />
      <path d="M36 32 C42 42 46 48 44 50 C40 46 36 38 36 32 Z" fill="#FF9F2E" />
  ...
  cat_yarn: (
    <>
      ...
      <circle cx="32" cy="36" r="20" fill="#ff5c8a" />
  ...
  catnip: (
    <>
      ...
      <circle cx="28" cy="46" r="1.5" fill="#ff5c8a" />
      <circle cx="36" cy="46" r="1.5" fill="#ff5c8a" />
      <path d="M30 49 C32 51 34 51 34 49" stroke="#ff5c8a" strokeWidth={1.5} fill="none" />
      <path d="M32 34 C32 22 22 18 16 22 C18 30 28 34 32 34 Z" fill="#62CC8A" />
      <path d="M32 34 C32 22 42 18 48 22 C46 30 36 34 32 34 Z" fill="#62CC8A" />
  ...
  cat_dance: (
    <>
      <circle cx="32" cy="36" r="18" fill="#FFC53D" />
      <path d="M16 20 V12 L28 8 V16 M28 8 L16 12" stroke="#FF9F2E" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="38" cy="30" r="4" fill="#ff5c8a" />
      <Face cx={32} cy={38} gap={5} dot={2.4} cheek={false} />
      <Glint cx={24} cy={28} rx={4} ry={2} />
    </>
  ),
  ...
  cat_stretch: (
    <>
      <path d="M10 40 Q 24 24 54 44" stroke="#FF9F2E" strokeWidth={5} strokeLinecap="round" fill="none" />
  ...
  cat_roll: (
    <>
      <circle cx="32" cy="32" r="22" fill="#dcebff" stroke="#3d9bff" strokeWidth={2.5} strokeDasharray="6 5" />
      <ellipse cx="32" cy="34" rx="8" ry="6" fill="#3d9bff" />
      <circle cx="24" cy="24" r="3" fill="#3d9bff" />
      <circle cx="32" cy="20" r="3" fill="#3d9bff" />
      <circle cx="40" cy="24" r="3" fill="#3d9bff" />
  ...
  cat_pinyinquest: (
    <>
      <path d="M16 36 L24 20 L32 30 H36 L44 20 L52 36 C54 42 10 42 16 36 Z" fill="#62CC8A" strokeLinejoin="round" />
  ...
  cat_mathquest: (
    <>
      <rect x="14" y="28" width="36" height="24" rx="6" fill="#FFC53D" />
      <path d="M12 28 L18 16 L26 26 H38 L46 16 L52 28 Z" fill="#FF9F2E" strokeLinejoin="round" />
      <circle cx="32" cy="38" r="4" fill="#ff5c8a" />
  ...
  cat_hanziquest: (
    <>
      ...
      <path d="M22 16 L28 8 L34 16" fill="#FF9F2E" />
      <path d="M30 16 L36 8 L42 16" fill="#FF9F2E" />
      <path d="M26 26 H38 M26 32 H38 M26 38 H38" stroke="#FF9F2E" strokeWidth={3} strokeLinecap="round" />
  ...
  cat_wardrobe: (
    <>
      ...
      <path d="M14 22 L22 10 L30 20 H34 L42 10 L50 22 Z" fill="#8f5bff" strokeLinejoin="round" />
      <line x1="32" y1="22" x2="32" y2="58" stroke="#8f5bff" strokeWidth={2} />
  ...
  cat_manor: (
    <>
      ...
      <path d="M26 56 V42 C26 38 38 38 38 42 V56 Z" fill="#8f5bff" />
  ...
  cat_toybox: (
    <>
      ...
      <path d="M10 24 C10 16 26 16 32 24 C38 16 54 16 54 24 Z" fill="#ff5c8a" strokeLinejoin="round" />

...
const FALLBACK_BOOKS: Record<StorybookTheme, FallbackBook> = {
  animals: {
    ...
    pages: [
      ...
      { title: '过河的挑战', content: '它们来到一条小河前，小狮子勇敢地背起小兔子，一步一步趟过了河水。', illustrationTheme: 'river', bgColor: '#dcebff', emoji: '🌊' },
      { title: '森林大冒险', content: '穿过森林时，它们遇到了一只友善的小大象，小大象用长鼻子帮它们摘到了高处的果子。', illustrationTheme: 'forest', bgColor: '#f0faf3', emoji: '🐘' },
  ...
  space: {
    ...
    pages: [
      { title: '发射倒计时', content: '小宇航员坐上了闪闪发光的火箭，三、二、一，嗖的一下飞向了神秘的太空！', illustrationTheme: 'launch', bgColor: '#dcebff', emoji: '🚀' },
      { title: '糖果星云', content: '太空深处的云朵居然全是棉花糖做的！小宇航员开心地摘了一朵品尝，甜极啦！', illustrationTheme: 'candy', bgColor: '#fff4d6', emoji: '🍬' },
      { title: '外星新朋友', content: '在一颗绿色的小星球上，小宇航员遇到了三只可爱的外星小嘟嘟，它们一起跳起了欢快的舞蹈。', illustrationTheme: 'alien', bgColor: '#f0faf3', emoji: '👾' },
  ...
  princess: {
    ...
    moral: '善良的心是最美的魔法',
    pages: [
      { title: '神秘的小种子', content: '小公主在城堡花园里捡到了一颗闪闪发光的种子，她小心翼翼地把它种在了花盆里。', illustrationTheme: 'garden', bgColor: '#ffe1eb', emoji: '🌱' },
  ...
  dinosaur: {
    ...
    pages: [
      ...
      { title: '遇见翼龙', content: '一只小翼龙从天上飞下来，告诉小恐龙远处有好多好玩的东西，它们决定一起去看看。', illustrationTheme: 'meeting', bgColor: '#dcebff', emoji: '🦴' },
      { title: '火山旁的温泉', content: '它们发现了一处温暖的温泉，小恐龙开心地在水里扑腾，溅起了好多水花！', illustrationTheme: 'volcano', bgColor: '#ffdeb0', emoji: '🌋' },
  ...
  ocean: {
    ...
    moral: '团结合作就能战胜困难',
    pages: [
      { title: '藏宝图', content: '小海豚在珊瑚礁里找到了一张藏宝图，上面画着一颗闪亮的珍珠藏在深海处。', illustrationTheme: 'map', bgColor: '#dcebff', emoji: '🗺️' },
      { title: '小乌龟帮忙', content: '小海豚找到了好朋友小乌龟，小乌龟背着它慢慢地游过了重重海草迷宫。', illustrationTheme: 'teamwork', bgColor: '#b7d8ff', emoji: '🐢' },
      { title: '螃蟹守门员', content: '一只小螃蟹守在宝藏前面，小海豚给小螃蟹讲了个笑话，小螃蟹笑得钳子都松开了。', illustrationTheme: 'crab', bgColor: '#3d9bff', emoji: '🦀' },
      { title: '闪亮的珍珠', content: '它们找到了珍珠！珍珠的光照亮了整个海底，小海豚和小伙伴们开心地围着珍珠转圈圈。', illustrationTheme: 'treasure', bgColor: '#0b5ec9', emoji: '🐚' },
    ],
  },
  forest: {
    title: '小蘑菇的森林奇遇',
    moral: '每个小生命都有大大的力量',
    pages: [
      { title: '雨后小蘑菇', content: '一场春雨过后，小蘑菇从泥土里探出了圆乎乎的脑袋，它好奇地打量着这片森林。', illustrationTheme: 'mushroom', bgColor: '#f0faf3', emoji: '🍄' },
      { title: '迷路的小蜗牛', content: '小蘑菇遇到了一只迷路的小蜗牛，它用自己的颜色给小蜗牛指路，帮它找到了家。', illustrationTheme: 'snail', bgColor: '#bcebce', emoji: '🐌' },
      { title: '萤火虫的舞会', content: '夜晚来了，一群萤火虫围着小蘑菇跳舞，把小蘑菇照得比灯笼还要亮！', illustrationTheme: 'fireflies', bgColor: '#53289f', emoji: '🦋' },
      { title: '森林的小英雄', content: '第二天，森林里的小动物们都来找小蘑菇玩。虽然它很小，但它觉得自己是世界上最幸福的蘑菇。', illustrationTheme: 'hero', bgColor: '#f0faf3', emoji: '🌟' },
    ],
  },
};

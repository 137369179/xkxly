...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'desktop_pet', label: '桌面宠物', short: '宠物', emoji: '🐾', tone: 'purple', desc: '互动桌面宠物 · 好感度/聊天/番茄钟' },
  ...
  { id: 'nursery', label: '儿歌跟唱', short: '跟唱', emoji: '🎶', imageIcon: '/icons/cover-songs.jpg', tone: 'pink', desc: '逐句跟唱 · 学知识明道理', bottom: true },
];

...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'hanzi-listen', label: '听音识字', short: '听音', emoji: '👂', imageIcon: '/icons/hanzi.jpg', tone: 'green', desc: '听读音 · 点选正确汉字', hiddenInSidebar: true },
  ...
  { id: 'realistic_cat', label: '写实猫咪3D', short: '写实猫', emoji: '🐈', imageIcon: '/icons/pink_felt_cat.png', tone: 'orange', desc: '真实毛发 · PBR渲染 · 品种切换', hiddenInSidebar: true },
  ...
  { id: 'rewards', label: '奖励中心', short: '奖励', emoji: '🎁', imageIcon: '/icons/parent.jpg', tone: 'pink', desc: '贴纸册 · 徽章墙', hiddenInSidebar: true },
  { id: 'passport', label: '学习护照', short: '护照', emoji: '🛂', imageIcon: '/icons/crown.png', tone: 'purple', desc: '盖章里程碑 · 成就墙', hiddenInSidebar: true },

...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'words', label: '英语单词乐园', short: '单词', emoji: '🔠', imageIcon: '/icons/cover-words.webp', tone: 'pink', desc: '300+ 生活主题词汇 · 美式真人原声' },
  ...
  { id: 'idioms', label: '成语消消乐', short: '成语', emoji: '🏯', imageIcon: '/icons/cover-idioms.webp', tone: 'purple', desc: '60 个成语典故 · 4x4 方块消除 · 寓言大决斗' },
  { id: 'storybook', label: '分级绘本岛', short: '绘本', emoji: '📚', imageIcon: '/icons/cover-storybook.png', tone: 'pink', desc: '自集字专属故事 · Level 1~5 分级阅读' },
  { id: 'songs', label: '儿歌乐园', short: '儿歌', emoji: '🎵', imageIcon: '/icons/cover-songs.webp', imageIconSmall: '/icons/cover-songs-480.webp', tone: 'pink', desc: '10 首经典童谣 · 节奏明快启蒙' },
  { id: 'nursery', label: '儿歌跟唱', short: '跟唱', emoji: '🎶', imageIcon: '/icons/cover-songs.webp', tone: 'pink', desc: '逐句跟唱伴学 · 知识儿歌好习惯', bottom: true },
  { id: 'science', label: '自然科学馆', short: '科学', emoji: '🦖', imageIcon: '/icons/cover-science.webp', tone: 'green', desc: '恐龙考古 · 植物生命周期 · 太空天气' },
  { id: 'music', label: '音乐律动坊', short: '音乐', emoji: '🎹', imageIcon: '/icons/cover-music.webp', imageIconSmall: '/icons/cover-music-480.webp', tone: 'pink', desc: '太鼓达人律动 · 彩虹琴视唱练耳' },
  { id: 'art', label: '艺术与填色', short: '艺术', emoji: '🎨', imageIcon: '/icons/cover-art.webp', tone: 'pink', desc: '魔力分块填色本 · 魔法调色盘 · 自由画板' },
  { id: 'safety', label: '安全情景剧场', short: '安全', emoji: '🚨', imageIcon: '/icons/cover-safety.webp', imageIconSmall: '/icons/cover-safety-480.webp', tone: 'blue', desc: '习惯模拟器 · 地震火灾逃生 · 出行防走失' },
  { id: 'geography', label: '环球 3D 地理', short: '地理', emoji: '🧭', imageIcon: '/icons/cover-geography.webp', tone: 'green', desc: '七大洲五大洋 · 地标名胜 · 护照集章' },
  { id: 'vehicles', label: '城市交通救援', short: '救援', emoji: '🚒', imageIcon: '/icons/cover-vehicles.webp', tone: 'orange', desc: '消防灭火 · 救护医疗 · 特警探案 · 挖掘机' },
  { id: 'festivals', label: '节气文化馆', short: '节气', emoji: '🏮', imageIcon: '/icons/cover-festivals.webp', tone: 'pink', desc: '二十四节气长卷 · 传统节日风俗' },
  { id: 'plants', label: '奇妙植物馆', short: '植物', emoji: '🪴', imageIcon: '/icons/cover-plants.webp', imageIconSmall: '/icons/cover-plants-480.webp', tone: 'green', desc: '向日葵生长 · 浇水光照光合作用' },
  ...
  { id: 'fun', label: '趣味竞技场', short: '竞技', emoji: '🎪', imageIcon: '/icons/cover-fun.webp', tone: 'purple', desc: '亲子对战 · 听力反应 · 创意搭建', hiddenInSidebar: true },
  ...
  { id: 'research', label: '探索研究乐园', short: '研究', emoji: '🔬', imageIcon: '/icons/cover-research.webp', imageIconSmall: '/icons/cover-research-480.webp', tone: 'blue', desc: '小课题探究 · 科学假设与验证' },
  { id: 'discoveries', label: '科学发现画廊', short: '画廊', emoji: '🖼️', imageIcon: '/icons/cover-discoveries.webp', tone: 'blue', desc: '探索记录 · 知识卡片 · 荣誉成果' },

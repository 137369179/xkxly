...
export const BODY_SYSTEMS: BodySystemItem[] = [
  {
    ...
    organs: [
      ...
      { id: 'stomach', nameZh: '胃', nameEn: 'Stomach', emoji: '🫧', position: { x: 38, y: 35 }, function: '用胃酸搅拌和分解食物', funFact: '胃酸强到能溶解铁钉！', sizeComparison: '能装约 1.5 升食物，像一个气球' },
      { id: 'small-intestine', nameZh: '小肠', nameEn: 'Small Intestine', emoji: '🌀', position: { x: 50, y: 52 }, function: '吸收食物中的营养', funFact: '小肠有 6-7 米长！', sizeComparison: '展开有一个停车场那么长' },
      { id: 'large-intestine', nameZh: '大肠', nameEn: 'Large Intestine', emoji: '🔄', position: { x: 50, y: 72 }, function: '吸收水分，形成便便', funFact: '大肠里有数万亿个细菌帮我们消化', sizeComparison: '约 1.5 米长，像一条粗管子' },
      { id: 'anus', nameZh: '肛门', nameEn: 'Anus', emoji: '💩', position: { x: 50, y: 88 }, function: '把便便排出体外', funFact: '健康的便便像香蕉的形状', sizeComparison: '和你的小指差不多粗' },
    ],
  },
  {
    id: 'respiratory',
    ...
    organs: [
      ...
      { id: 'lung-left', nameZh: '左肺', nameEn: 'Left Lung', emoji: '🫁', position: { x: 35, y: 40 }, function: '和右肺一起交换氧气和二氧化碳', funFact: '左肺比右肺小一点，给心脏腾位置', sizeComparison: '像一个大海绵' },
      { id: 'lung-right', nameZh: '右肺', nameEn: 'Right Lung', emoji: '🫁', position: { x: 62, y: 40 }, function: '和左肺一起交换氧气和二氧化碳', funFact: '右肺有 3 叶，左肺只有 2 叶', sizeComparison: '比左肺大一点' },
      { id: 'alveoli', nameZh: '肺泡', nameEn: 'Alveoli', emoji: '🫧', position: { x: 50, y: 50 }, function: '氧气和二氧化碳交换的地方', funFact: '肺里有 3 亿个肺泡！', sizeComparison: '每个肺泡只有 0.2 毫米' },
    ],
  },
  {
    id: 'circulatory',
    ...
    organs: [
      ...
      { id: 'vein', nameZh: '静脉', nameEn: 'Vein', emoji: '🔵', position: { x: 68, y: 50 }, function: '把含二氧化碳血液送回心脏', funFact: '静脉血是暗红色的', sizeComparison: '静脉比动脉粗但壁薄' },
      { id: 'capillary', nameZh: '毛细血管', nameEn: 'Capillary', emoji: '🩸', position: { x: 50, y: 65 }, function: '和细胞交换氧气和营养', funFact: '毛细血管比头发还细 10 倍', sizeComparison: '只有 0.008 毫米粗' },
    ],
  },
  {
    id: 'skeletal',
    ...
    color: '#FFE8A3',
    organs: [
      { id: 'skull', nameZh: '头骨', nameEn: 'Skull', emoji: '💀', position: { x: 50, y: 6 }, function: '保护大脑', funFact: '头骨由 22 块骨头拼成', sizeComparison: '和你的头一样大' },
      { id: 'spine', nameZh: '脊柱', nameEn: 'Spine', emoji: '🦴', position: { x: 50, y: 35 }, function: '支撑身体，保护脊髓', funFact: '脊柱由 33 块椎骨组成', sizeComparison: '从脖子到腰，约 70 厘米' },
      { id: 'ribs', nameZh: '肋骨', nameEn: 'Ribs', emoji: '🫁', position: { x: 50, y: 38 }, function: '保护心脏和肺', funFact: '人有 12 对肋骨', sizeComparison: '像一个小笼子' },
      { id: 'arm-bone', nameZh: '手臂骨', nameEn: 'Arm Bone', emoji: '💪', position: { x: 20, y: 45 }, function: '让手臂能弯曲活动', funFact: '手臂由肱骨、尺骨和桡骨组成', sizeComparison: '约 30 厘米长' },
      { id: 'leg-bone', nameZh: '腿骨', nameEn: 'Leg Bone', emoji: '🦵', position: { x: 42, y: 68 }, function: '支撑身体，走路跑步', funFact: '大腿骨是身体最长的骨头', sizeComparison: '约 45 厘米长' },
    ],
  },
  {
    id: 'nervous',
    ...
    organs: [
      ...
      { id: 'spinal-cord', nameZh: '脊髓', nameEn: 'Spinal Cord', emoji: '🧵', position: { x: 50, y: 35 }, function: '传递大脑和身体之间的信号', funFact: '脊髓约 45 厘米长', sizeComparison: '和一根铅笔差不多粗' },
      { id: 'nerves', nameZh: '神经', nameEn: 'Nerves', emoji: '⚡', position: { x: 50, y: 55 }, function: '把信号传遍全身', funFact: '神经连起来有 7 万公里长', sizeComparison: '比头发还细' },
    ],
  },
  {
    id: 'sensory',
    ...
    organs: [
      ...
      { id: 'nose-organ', nameZh: '鼻子', nameEn: 'Nose', emoji: '👃', position: { x: 50, y: 10 }, function: '闻味道', funFact: '能识别 1 万种气味', sizeComparison: '鼻腔约 7.5 厘米深' },
      { id: 'tongue', nameZh: '舌头', nameEn: 'Tongue', emoji: '👅', position: { x: 50, y: 12 }, function: '尝味道', funFact: '有 1 万个味蕾，每 2 周更新', sizeComparison: '长约 10 厘米' },
      { id: 'skin', nameZh: '皮肤', nameEn: 'Skin', emoji: '✋', position: { x: 50, y: 50 }, function: '感受冷热软硬，保护身体', funFact: '皮肤是全身最大的器官', sizeComparison: '成人皮肤面积约 2 平方米' },
    ],
  },
];
